...
export default function Favorites(props) {
	...
	if (!userLogged) {
		return <UserNoLogged setReloadRestaurants={setReloadRestaurants} navigation={navigation} />;
	}
			...
			.then((response) => {
				response.forEach((doc) => {
					...
					db
						...
						.catch(() => {
							toastRef.current.show('Error al eliminar el restaurante, intentelo más tarde');
						});
				});
			});
	};
